...
$api_key = 'f7cc05b6a06c512416554c731bc06ee076633953';
...
$myfile = fopen("lazada_check_stocks.xml", "r") or die("Unable to open file!");
$input_xml =  fread($myfile,filesize("lazada_check_stocks.xml"));
fclose($myfile);
